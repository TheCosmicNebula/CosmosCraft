# CosmosCraft
A Minecraft mod that adds ores, machines, tools and more useful things! Currently using MinecraftForge 1.16.3.
...
## You can:
 ...
 - Create a Fork of this repository if you satisfy the following conditions:
   - You do not change the package base name. (com.tcn or com.tcn.cosmoscraft)
